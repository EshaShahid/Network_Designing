...
Allocate IP addresses and subnets based on building and user requirements.

Justify device choices and evaluate the design.
...
IP address subnetting using VLSM.

DHCP server placement and allocation strategy.

Floor plan-based LAN design.

Support for mobile devices and scalability.
...
LAN_MainBuilding.png – Detailed LAN design for Main Building.

LAN_LRC.png – Detailed LAN design for Learning Resource Centre.

IP_Calculations.xlsx – Subnetting and IP addressing spreadsheet.
...
DHCP servers deployed at distribution layer.
